...
export class OpenAiBlogDraftService {
  ...
  private buildPromptText = (
    ...
    return [
      ...
      '- 좋은 제목 예시: 수빈이랑 서울 데이트 💛 / 오랜만에 제대로 놀고 왔다! / 굿즈 사고 한강까지 완벽했던 하루 / 오늘도 추억 하나 추가 :) / 귀여운 것만 잔뜩 보고 온 하루 / 수빈이랑 놀면 시간이 왜 이렇게 빨라',
      ...
      '- 본문에는 비슷한 느낌의 이모지를 가끔 사용할 수 있지만, 과하게 반복하지 않는다.',
      '- 문장 길이와 어미를 다양하게 섞어 실제 사람이 쓴 여행 후기처럼 자연스럽게 작성한다.',
      '- "특히", "또한", "한편", "무엇보다" 같은 연결어를 반복해서 사용하지 않는다.',
      '- 약간의 여운이나 담백한 표현을 사용할 수 있다.',
      '- !, ~, …는 자연스럽게 사용할 수 있지만, !!!, ~~~, ㅎㅎㅎ 같은 과한 표현은 사용하지 않는다.',
